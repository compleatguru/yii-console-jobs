 ...
 */
class CreativeProject extends CActiveRecord {
    ...
    public function saveProject() {
        ...
        if($this->current_template_id != $this->template_id){
            $this->changeTemplate();
        }
    ...
    private function changeTemplate(){
        ...
        $medias = CreativeProjectQuestionMedia::model()->findAll($criteria);
        $fileStoreService = new FileStoreService;
        /* @var $media CreativeProjectQuestionMedia */
        foreach($medias as $media){
            $fileStoreService->deleteFile($media->path);
        }
    ...
    protected function afterFind() {
        ...
        $this->current_template_id = $this->template_id;
        parent::afterFind();
    }
    ...
    public function reLaunchProject(){
        // Must call delete API then Launch API
