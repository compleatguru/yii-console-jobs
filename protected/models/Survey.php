...
class Survey extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('launched, closed, status, country', 'numerical', 'integerOnly'=>true),
			array('name', 'safe'),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, name, launched, closed, status, country', 'safe', 'on'=>'search'),
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('launched',$this->launched);
